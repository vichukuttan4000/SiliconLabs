...
extern int   SL_TFLITE_MODEL_AUDIO_FEATURE_GENERATION_AUDIO_BUFFER_SIZE;
extern int   SL_TFLITE_MODEL_AUDIO_FEATURE_GENERATION_AUDIO_GAIN;
...
// <i> Default: 16384
#define SL_ML_AUDIO_FEATURE_GENERATION_AUDIO_BUFFER_SIZE               16384
...
#undef SL_ML_AUDIO_FEATURE_GENERATION_AUDIO_BUFFER_SIZE
#undef SL_ML_AUDIO_FEATURE_GENERATION_AUDIO_GAIN
#define SL_ML_AUDIO_FEATURE_GENERATION_AUDIO_BUFFER_SIZE      SL_TFLITE_MODEL_AUDIO_FEATURE_GENERATION_AUDIO_BUFFER_SIZE
#define SL_ML_AUDIO_FEATURE_GENERATION_AUDIO_GAIN             SL_TFLITE_MODEL_AUDIO_FEATURE_GENERATION_AUDIO_GAIN
