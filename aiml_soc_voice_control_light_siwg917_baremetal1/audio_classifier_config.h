...
extern npu_toolkit::StringList SL_TFLITE_MODEL_CLASSES;
extern npu_toolkit::Int32List SL_TFLITE_DETECTION_THRESHOLD_LIST;
extern int SL_TFLITE_MODEL_BAUD_RATE;
